...
\raisebox{-0.05\height}\faPhone \ (+86) 188-0500-6918 \quad \faHome \ 5 Yiheyuan Road, Haidian District, Beijing 100871, China \\
\raisebox{-0.05\height}\faEnvelope \ \href{mailto:peanuttang1320061044@gmail.com}{peanuttang1320061044@gmail.com}, \href{mailto:huangst26@stu.pku.edu.cn}{huangst26@stu.pku.edu.cn} \\
\raisebox{-0.05\height}\faGlobe \ \href{https://peanut-tang.github.io/}{peanut-tang.github.io} \quad \faGraduationCap \ \href{https://scholar.google.com/citations?user=ZW6vsmAAAAAJ}{My Google Scholar} \\
\end{tabularx}
...
\textbf{Peking University (PKU)}, Beijing, China \hfill \textit{Sept. 2026 $\sim$ Present}  \vspace{-0.1cm}
\begin{itemize}
    \item Doctor of Philosophy in Computer Science  \vspace{-0.25cm}
    \item Center on Frontiers of Computing Studies \hfill \textit{supervised by Prof. Kuan Cheng}
\end{itemize}

\textbf{University of Science and Technology of China (USTC)}, Hefei, China \hfill \textit{Aug. 2022 $\sim$ Jun. 2026}  \vspace{-0.1cm}
\begin{itemize}
    \item Bachelor of Engineering in Computer Science and Technology  \vspace{-0.25cm}
    \item School of the Gifted Young \hfill \textit{supervised by Prof. Xue Chen}  \vspace{-0.25cm}
    \item \textbf{Overall GPA: 3.9/4.30, top 5\%} \hfill \textbf{Major GPA: 4.01/4.30}  \vspace{-0.25cm}
    \item \textbf{Core Courses:} Foundations of Algorithms (100), Computer Organization (95), Advanced Combinatorics (100), Probability Theory \& Its Outer Chapter (100, 100), Advanced Probability Theory *(100), Graph Theory *(92), Regression Analysis (97), Operations Research (96).  \vspace{-0.25cm}
\end{itemize}
...
\textbf{In theoretical computer science, unless stated otherwise, authors are ordered \underline{alphabetically} and \underline{contribute equally} to the project.}  \vspace{-0.1cm}

\begin{enumerate}
    \item \textbf{Stronger Lower Bounds for Tree Covers via Cyclic Symmetry} \\
           \underline{Shengtang Huang} \\
           Manuscript, 2026
    
    \item \textbf{Constructions of $k$-Min-Wise Hash from Bounded Independence} \\
           Xue Chen, \underline{Shengtang Huang}, Xin Li \\
           Manuscript, 2026

    \item \textbf{High-Rate Public-Key Pseudorandom Codes for Edit Errors} \\
           \underline{Shengtang Huang}, Xin Li, Songtao Mao, Zhaienhe Zhou \\
           Manuscript, 2026
...
\begin{itemize}
    \item \textbf{Outstanding Graduate Honors 2026} at the Anhui provincial level, USTC university level, and the School of the Gifted Young level. \vspace{-0.25cm}
