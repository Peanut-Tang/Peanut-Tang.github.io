...
\raisebox{-0.05\height}\faPhone \ (+86) 188-0500-6918 \quad \faHome \ 96 Jinzhai Road, Hefei, Anhui, 230026, China \\
...
\textbf{Peking University (PKU)}, Beijing, China \hfill \textit{Excepted Sept. 2026 $\sim$}  \vspace{-0.1cm}
\begin{itemize}
    \item Doctor of Philosophy in Computer Science  \vspace{-0.25cm}
    \item Center on Frontiers of Computing Studies \hfill \textit{supervised by Prof. Kuan Cheng \&\& Prof. Tianren Liu}
\end{itemize}
...
\textbf{Following the convention in theoretical computer science, unless stated otherwise, authors are ordered \underline{alphabetically} and \underline{contribute equally} to the project.}  \vspace{-0.1cm}
