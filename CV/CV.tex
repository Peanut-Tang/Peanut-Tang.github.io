...
%     >{\raggedright\arraybackslash}X 
%     >{\raggedright\arraybackslash}X }
%         \textbf{Prof. Xue Chen (陈雪)}                              & \textbf{Prof. Xin Li (李新)} \\
%         Prof.                                                      & Associate Prof. \\
...
%         \href{mailto:xuechen1989@ustc.edu.cn}{xuechen1989@ustc.edu.cn} & \href{mailto:lixints@cs.jhu.edu}{lixints@cs.jhu.edu} \\
%          & \\
%         \textbf{Prof. Shixiang Chen (陈士祥)}                       & \textbf{Prof. Slobodan Mitrović} \\
%         Assistant Prof.                                            & Assistant Prof. \\
%         School of Mathematical Sciences                                & Department of Computer Science \\
%         University of Science and Technology of China                  & University of California, Davis \\
%         \href{mailto:shxchen@ustc.edu.cn}{shxchen@ustc.edu.cn}         & \href{mailto:smitrovic@ucdavis.edu}{smitrovic@ucdavis.edu}
% \end{tabularx}
