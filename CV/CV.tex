...
\textit{Advisors: Xue Chen, USTC; Fernando Granha Jeronimo, UIUC; Xin Li, JHU \hfill Jul. 2025 $\sim$ Present}  \vspace{-0.1cm}
\begin{itemize}
...
\begin{itemize}
    \item Jointly discussed with Prof. Xin Li and his Ph.D student Yan Zhong, building directly upon their prior impossibility result for range avoidance.  \vspace{-0.25cm}
    \item Contributed to finalizing the hardness proof and participated in writing the manuscript, which was accepted to \textbf{ITCS 2026}.
\end{itemize}
